...
/**
 * Reference-data migration: the 'trello' Integration row. selectIntegration
 * keys the client registry off this name — without the row, trello boards
